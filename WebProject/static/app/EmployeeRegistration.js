Vue.component("employeeRegistration", {
	...
	<div class="reg">
		<div class="container">
			<p id="title" class="text-center">EMPLOYEE REGISTRATION</p>
			<div id="form" class="container">
				<div>
				  <label>EMPLOYEE POSITION</label>
			  	  <select id="gender_select"  class="form-select form-select-sm" aria-label=".form-select-sm example" v-model="userType">
